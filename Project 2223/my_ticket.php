...
<head>
    ...
    <div class="tilte-ticket" style="background-color: #EFEBDB;">
        <h5 class="text-center my-auto pt-2 pb-2"><strong>MY TICKETS</strong></h5>
    </div>
</head>
    ...
    <div class="container my-4">
        <table class="table-bordered table table-hover text-center">
            ...
            foreach($ticket as $tic) {
                ?>
                <tr>
                    <td class="align-middle"><?= $tic['film'] ?></td>
                    <td class="align-middle"><?= $tic['day'] ?></td>
                    <td class="align-middle"><?= $tic['theater_time'] ?></td>
                    <td class="align-middle"><?= $tic['chair'] ?></td>
                </tr>
                <?php
            }
            ?>
        </table>
        <p class="text-right">Total tickets: <strong><?= count($ticket)?></strong></p>
    </div>
