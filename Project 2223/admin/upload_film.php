    ...
    if (isset($_POST['name']) && isset($_POST['time']) && isset($_POST['detail']))
    {
        ...
        if (empty($name)) {
            ...
            if(!check_exist_name($name, 'now_films')) {
                upload_films($name, $_FILES['image']['name'], $time, $detail, 'now_films');
                $result = upload_nowfilms($_FILES['image']);
                if($result['code'] == 0) {
...
<head>
    ...
    <title>Adding movies now showing</title>
    ...
    <div class="tilte-login" style="background-color: #EFEBDB;">
        <h5 class="text-center my-auto pt-2 pb-2"><strong>ADD THE MOVIE NOW SHOWING</strong></h5>
    </div>
</head>
            ...
            <div class="col-lg-4 col-md-5 form-poster mt-4 mb-4 pl-5 pr-5 pt-4 pb-2">
                ...
                <form method="post" novalidate enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input value="<?= $name ?>" name="name" required class="form-control" type="text" placeholder="Name of the movie now showing" id="name">
                    </div>
