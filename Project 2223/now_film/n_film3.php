...
<div style="background-color:#3b3b3b;" class="pb-4 pt-4">
    <div class="embed-responsive embed-responsive-16by9 ">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/tCC7hrheTR8" title="SOULMATE (tựa Việt: Tri Kỷ) - Trailer chính thức - Khởi chiếu: 24.03.2023" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>        </div>
...
<div class="container-fluid background">
    <div class="row">
        <div class="col-xl-3 col-md-3 col-sm-12 pb-4 pt-4" height="304" width="175" >
            <div>
                <img class="mx-auto d-block pb-3" height="275" width="175" src="https://www.cgv.vn/media/catalog/product/cache/1/image/c5f0a1eff4c394a251036189ccddaacd/s/o/soulmate-_vietnamese_poster.jpg">
            </div>    
            <div>
            <a href="http://<?= $server_host ?>/booking.php?title_movie=TRI KỶ"><button class="button-film mx-auto d-block" height="44" width="175" >Đặt vé</button></a>
            </div>
        </div>
        <div class="col-xl-8 col-md-8 col-sm-12 pb-4 pt-4"> 
            <ul style=" font-size: 15px;">
                <li>
                <h4><strong>TRI KỶ</strong></h4>
                    <strong>Đánh giá:
                ...
                <li><Strong>Đạo diễn: </Strong>Young-Keun Min</li>
                <li><Strong>Diễn viên: </Strong>Kim Da-mi, Woo-Seok Byeon, Nam Yoon-Su, So-nee Jeon, Kim Soo Hyung</li>
                <li><Strong>Khởi chiếu: </Strong>24/03/2023</li>
                <li><Strong>Thời lượng: </Strong>124 phút</li>
                <li class="pt-4">
                    <h5><STRONG>Tóm tắt</STRONG></h5>
                    <p>Tri Kỷ (Soulmate) giống như là một bức thư tình với nhiều niềm vui, nỗi buồn, tình yêu và khao khát dành cho tình bạn gắn kết bền chặt hơn cả tình yêu lãng mạn của những người phụ nữ. Với màn trình diễn tuyệt vời, đáng mong đợi của Kim Da Mi và Jeon So Nee từ khi còn là những thanh thiếu niên thôn quê cho đến khi trưởng thành</p>
                </li>
            </ul>
        </div>
    </div>    
